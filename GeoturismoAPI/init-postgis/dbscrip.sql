...
CREATE TABLE IF NOT EXISTS eventos(
    ...
    id_eventos UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS filtros(
    ...
    Constraint fk_local FOREIGN KEY (locais_id) REFERENCES locais(id_locais),
    Constraint fk_categoria FOREIGN KEY (categorias_id) REFERENCES categorias(id_categorias)
